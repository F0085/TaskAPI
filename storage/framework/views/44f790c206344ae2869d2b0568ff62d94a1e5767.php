                    ...
                    <ul class="clearfix">
                        ...
                        <li class="icons dropdown">
                          ...
                          <!--               <li>
                                        ...
                                        <li><a href="<?php echo e(route('logout')); ?>" ><i class="icon-key"></i> <span>Cerrar Sesión</span></a>
                                        <?php else: ?>
...
<!--                     <li>
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Gestión Administrativa</span>
                        </a>
                        <ul aria-expanded="false">
